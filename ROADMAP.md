...
**Day 7**: **VPS deploy COMPLETE** (PR #8 → `4277951`, live on a Hetzner CX33 — cold `/recommend` 701 s
/ warm 12 s validated in prod, 2026-05-27); the first **evaluation round** against benchmark seeds is
the remaining Day-7 work. Deploy-hardening items carried from the Day-6 adversarial reviews (rationale
in DECISIONS.md):
